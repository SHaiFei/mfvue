<template>
    ...
    <div class="all-data-detail">
        ...
        <el-table :data="tableData" stripe style="width:100%;margin-top: 10px" @selection-change='tableDataSelect'>
            ...
            <el-table-column prop="completionTime" label="评定时间" align="center"></el-table-column>
        </el-table>
...
import { tableDataProductionList } from '@/api/engineering/security/production'
...
export default {
    ...
    methods: {
        getTableDataList () { // 题库维护列表
            tableDataProductionList(this.queryInfo).then(res => {
                if (res.code == 200) {
