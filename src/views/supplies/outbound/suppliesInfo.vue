        ...
        <div class="pageStyle">
            <el-row class="elRow">
                <div class="elRowLeft">
                    ...
                    <el-input v-model="queryInfo.MATERIAL_CODE" clearable class="elinput200"></el-input>
                    <span class="font-12 spanText">出库类型</span>
                    <el-input v-model="queryInfo.EXT3" clearable class="elinput200"></el-input>
            ...
            <el-table stripe :data="tableData" style="width: 100%" @selection-change="tableDataSelect" @row-click="clickRow" ref="multipleTable">
                ...
                <el-table-column prop="MATERIAL_CODE" label="物资编码" align="center"></el-table-column>
                ...
                <el-table-column prop="typeName" label="物资类别" align="center"></el-table-column>
                <el-table-column prop="quantity" label="数量" align="center"></el-table-column>
                <el-table-column prop="EXT3" label="出库类型" align="center"></el-table-column>
                <el-table-column prop="STORINGDATE" label="扫描出库时间" align="center"></el-table-column>
            </el-table>
...
<script>
import { tableDataList, addApply,  } from "@/api/supplies/outbound/suppliesInfo";
export default {
    data () {
        return {
            tableData: [],
