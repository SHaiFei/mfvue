<template>
    <div class="all-data-detail">
        <el-breadcrumb separator="/" class="all-titles">
            ...
            <el-breadcrumb-item>物资超期管理</el-breadcrumb-item>
        </el-breadcrumb>
        <div class="pageStyle">
            <el-row class="elRow">
                <div class="elRowLeft">
                    ...
                    <el-input v-model="queryInfo.materialId" clearable class="elinput200"></el-input>
            ...
            <el-table stripe :data="tableData" style="width: 100%" @selection-change="tableDataSelect" @row-click="clickRow" ref="multipleTable">
                ...
                <el-table-column prop="wzkName" label="物资仓库" align="center"></el-table-column>
                <el-table-column prop="operateDate" label="生产时间" align="center"></el-table-column>
                <el-table-column prop="baozhiqi" label="保质期限(月)" align="center"></el-table-column>
                <!-- <el-table-column prop="" label="超期数量" align="center"></el-table-column> -->
            </el-table>
...
<script>
import { tableDataList, exportData, } from "@/api/supplies/inventory/overdue";
