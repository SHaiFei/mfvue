<template>
    <div class="all-data-detail">
        <el-breadcrumb separator="/" class="all-titles">
            ...
            <el-breadcrumb-item>物资调配管理</el-breadcrumb-item>
        </el-breadcrumb>
        <div class="pageStyle">
            <el-row class="elRow">
                <div class="elRowLeft">
                    ...
                    <span class="font-12 spanText">调配单号</span>
                    <el-input v-model="queryInfo.billid" clearable class="elinput200"></el-input>
                    <el-button type="primary" size="small" icon="el-icon-search" @click="search">查询</el-button>
                </div>
                <div class="buttons">
                    <el-button type="parmary" size="small" @click="">查询条件设置</el-button>
                </div>
            </el-row>
            <!--  -->
            <el-table stripe :data="tableData" style="width: 100%" @selection-change="tableDataSelect" @row-click="clickRow" ref="multipleTable">
                ...
                <el-table-column prop="billid" label="调配单号" align="center"></el-table-column>
                ...
                <el-table-column prop="handleId" label="操作人" align="center"></el-table-column>
                <el-table-column prop="applyDate" label="调配日期" align="center"></el-table-column>
...
<script>
import { tableDataList, } from "@/api/supplies/inventory/allocate";
...
export default {
    ...
    methods: {
        ...
        search () { //查询
            ...
            this.queryInfo.danwei = this.$refs.headerChild.department
            this.getTableDataList()
        },
        closeDialog(){
