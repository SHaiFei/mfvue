...
import { comprehensiveAdd, comprehensiveEdit } from "@/api/engineering/security/comprehensive"
    ...
    mounted () {
        this.$nextTick(() => {
            if (this.formData != null) {
                ...
                // this.form.dataType = parseInt(rowData.dataType)
                this.form.dataType = rowData.dataType
            ...
            this.$refs.form.validate(valid => {
                if (valid) {
                    if (this.rowData != null) {
                        ...
                        comprehensiveEdit(this.form).then(res => {
                            if (res.code == 200) {
                        ...
                        comprehensiveAdd(this.form).then(res => {
                            if (res.code == 200) {
                                this.msgSuccess(res.msg)
                                this.$parent.$parent.dialogFormVisible = false
                                this.$parent.$parent.getTableDataList()
