    ...
    <div class="all-data-detail">
        ...
        <el-tabs type="border-card" v-model="activeName">
            ...
            <el-tab-pane label="统计表" name="project3" :disabled="isDisabled">
                <el-form :model="form3" ref="form3" class="form3" label-width="auto" v-if="activeName == 'project3'">
                    <el-row :gutter="24">
                        <el-col :span="12">
                    ...
                    <el-row style="margin-bottom: 10px">
                        <el-button @click="addDomain" size="small" type="primary">添 加</el-button>
                        <el-button @click="removeDomain" size="small" type="danger">删 除</el-button>
                    </el-row>
                    <el-row :gutter="24" v-for="(domain, index) in domains" :key="domain.key">
                        ...
                        <el-col :span="12">
                            <el-form-item label="现场核查内容情况">
                                ...
                                <span class="addVerification" @click="addVerification(domain)">核查内容</span>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
            ...
            <el-table :data="tableData" style="width:100%" border>
                ...
                <el-table-column prop="big_type" label="大类设备" align="center">
                    <template slot-scope="scope">
                        ...
                        <!-- <el-input v-model="scope.row.big_type"></el-input> -->
                    </template>
                </el-table-column>
...
import { projectList, projectList2, projectList3 } from '@/api/examination/engineering'
    ...
    methods: {
        projectList1 () { // 列表
            ...
            projectList(projectId).then(res => {
                if (res.code == 200) {
                    let data = res.data
                    this.form1.PROJECTNAME = data.PROJECTNAME
                    this.form1.JDBGBH = data.JDBGBH
                    this.form1.COMPANY1 = data.COMPANY1
                    this.form1.STREET_NAME = data.STREET_NAME
                    this.form1.COMPRNY1LXR = data.COMPRNY1LXR
                    this.form1.COMPRNY1DH = data.COMPRNY1DH
                    this.form1.COMPANY2 = data.COMPANY2
                    this.form1.COMPANY2lxr = data.COMPANY2lxr
                    this.form1.COMPANY2LXR = data.COMPANY2LXR
                    this.form1.COMPANY2DH = data.COMPANY2DH
                    this.form1.ADDRESS = data.ADDRESS
                    this.form1.STRUCTURE = data.STRUCTURE
                } else {
        ...
        projectList2 () {  //   单位信息
            this.tableData2 = []
            projectList2({ PROJECTID: this.rowId.id, TYPE: this.rowId.type }).then(res => {
                if (res.code == 200) {
                    let data = res.data
                    this.form2.COMPANY1 = data.company1
                    this.form2.COMPRNY1FR = data.comprny1fr
                    this.form2.COMPRNY1LXR = data.comprny1lxr
                    this.form2.COMPRNY1FRDH = data.comprny1frdh
                    this.form2.COMPRNY1DH = data.comprny1dh
                    this.form2.COMPANY2 = data.company2
                    this.form2.COMPRNY2FR = data.comprny2fr
                    this.form2.COMPRNY2LXR = data.comprny2lxr
                    this.form2.COMPRNY2FRDH = data.comprny2frdh
                    this.form2.COMPRNY2DH = data.comprny2dh
                    this.form2.COMPANY3 = data.company3
                    this.form2.COMPRNY3FR = data.comprny3fr
                    this.form2.COMPRNY3LXR = data.comprny3lxr
                    this.form2.COMPRNY3FRDH = data.comprny3frdh
                    this.form2.COMPRNY3DH = data.comprny3dh
                    this.form2.COMPANY4 = data.company4
                    this.form2.COMPRNY4FR = data.comprny4fr
                    this.form2.COMPRNY4LXR = data.comprny4lxr
                    this.form2.COMPRNY4FRDH = data.comprny4frdh
                    this.form2.COMPRNY4DH = data.comprny4dh
                } else {
                    this.msgError(res.msg)
                }
            })
        ...
        projectList3 () {  // 页签3 数据
            this.tableData3 = []
            projectList3({ PROJECTID: this.rowId.id }).then(res => {
                if (res.code == 200) {
                    let data = res.data
                    this.form3.ZONGMJ = data.ZONGMJ
                    this.form3.GCLB = data.GCLB
                    this.form3.GCBH = data.GCBH
                    this.form3.JDZB = data.JDZB
                    this.form3.JZMJ = data.JZMJ
                    this.form3.JGXS = data.JGXS
                    this.form3.TDMJ = data.TDMJ
                    this.form3.GLYFMJ = data.GLYFMJ
                    this.form3.PEACE_USE = data.PEACE_USE
                    this.form3.ZSGN = data.ZSGN
                    this.form3.KLDJ = data.KLDJ
                    this.form3.YSSJ = data.YSSJ
                    this.form3.DXCS = data.DXCS
                    this.form3.DSCS = data.DSCS
                    this.form3.RFSZC = data.RFSZC
                    this.form3.BJQWZ = data.BJQWZ
                    this.form3.DYSL = data.DYSL
                    this.form3.JKWZ = data.JKWZ
                    this.form3.GCNCWS = data.GCNCWS
                    this.form3.TZDH = data.TZDH
                    this.form3.FHDJ = data.FHDJ

                    this.domains = data.DY
                } else {
                    this.msgError(res.msg)
                }
            })
        ...
        addDomain () {  // 动态添加单元
            ...
            params.append("PROJECTID", this.rowId.id)
        ...
        projectEdit () {   // 页签1 修改
            this.form1.PROJECTID = this.rowId.id
        ...
        projectTwo () { //  列表 2 添加
            this.form2.PROJECTID = this.rowId.id
        ...
        projectThree () { //  列表 3 添加
            this.form3.PROJECTID = this.rowId.id
