<template>
    <div class="all-data-detail">
        <el-breadcrumb separator="/" class="all-titles">
            ...
            <el-breadcrumb-item>报废移出</el-breadcrumb-item>
        </el-breadcrumb>
        <div class="pageStyle">
            <el-row class="elRow">
                <div class="elRowLeft">
            ...
            <el-table ref="multipleTable" :data="tableData" stripe style="width:100%;margin-top: 10px" @selection-change='tableDataSelect'>
                ...
                <el-table-column prop="ydate" label="报废时间" align="center"></el-table-column>
...
<script>
import { scrapoutList } from '@/api/engineering/security/centralOrgan'
...
export default {
    components: {
        centralOrganTable, areaCom, centralOrganForm
    },
    data () {
        return {
            queryInfo: { // 分页
    ...
    methods: {
        getTableDataList () { // 题库维护列表
            scrapoutList(this.queryInfo).then(res => {
                if (res.code == 200) {
