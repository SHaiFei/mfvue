            ...
            projectList(projectId).then(res => {
                if (res.code == 200) {
                    this.tableData1.push(
                        { data1: "工程名称", data2: res.data.PROJECTNAME, data3: "监督报告编号", data4: res.data.JDBGBH },
                        { data1: "建设单位名称", data2: res.data.COMPANY1, data3: "所属街道", data4: res.data.STREET_NAME },
                        { data1: "建设单位联系人", data2: res.data.COMPANY1lxr, data3: "建设单位电话", data4: res.data.COMPANY1dh },
                        { data1: "施工单位", data2: res.data.COMPANY2, data3: "施工单位联系人", data4: res.data.COMPANY2lxr },
                        { data1: "施工单位电话", data2: res.data.COMPANY2dh, data3: "建设地址", data4: res.data.ADDRESS },
                        { data1: "结构形式", data2: res.data.STRUCTURE, data3: "", data4: "" },
                    )
                } else {
                    this.msgError(res.msg)
                }
            ...
            projectList2({ PROJECTID: this.$route.query.id, TYPE: this.$route.query.type }).then(res => {
                if (res.code == 200) {
                    this.tableData2.push({
                        ...
                        data1: res.data.COMPANY2,
                        data2: "102932432421831",
                        data3: "48325974329579"
                    }, {
            ...
            projectList3({ PROJECTID: this.$route.query.id }).then(res => {
                if (res.code == 200) {
                    this.tableData3.push(
                        ...
                        { data1: "工程地址", data2: res.data.KLDJ, data3: "防化等级", data4: res.data.FHDJ },
                    )
