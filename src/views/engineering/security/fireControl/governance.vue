    ...
    <div class="all-data-detail">
        <el-row class="elRow">
            <div class="elRowLeft">
                ...
                <span class="font-12 spanText">发现时间</span>
                <el-input v-model="queryInfo.completionTime" clearable class="elinput200"></el-input>
                <span class="font-12 spanText">隐患名称</span>
                <el-input v-model="queryInfo.dangerName" clearable class="elinput200"></el-input>
                <el-button type="primary" size="small" icon="el-icon-search" @click="search">查询</el-button>
            </div>
            <div class="buttons">
                <!-- <el-button type="primary" size="small" @click="" icon="el-icon-view">查看</el-button> -->
                <el-button type="primary" size="small" @click="" icon="el-icon-view" @click="eng">查看工程</el-button>
            </div>
        </el-row>
        <el-table :data="tableData" stripe style="width:100%;margin-top: 10px" @selection-change='tableDataSelect'>
            ...
            <el-table-column prop="dangerName" label="隐患名称" align="center"></el-table-column>
            <el-table-column prop="completionTime" label="发现隐患时间" align="center"></el-table-column>
        </el-table>
...
<script>
import { tableDataGovernanceList, undergroundList } from '@/api/engineering/security/fireControl'
...
export default {
    ...
    methods: {
        getTableDataList () {
            tableDataGovernanceList(this.queryInfo).then(res => {
                if (res.code == 200) {
