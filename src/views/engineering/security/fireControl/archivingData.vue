    ...
    <div class="all-data-detail">
        <el-row class="elRow">
            ...
            <div class="buttons">
                ...
                <el-button type="success" size="small" icon="el-icon-edit" @click="edit" :disabled="isFile">修改</el-button>
                <el-button type="danger" size="small" icon="el-icon-delete" @click="del" :disabled="isFile">删除</el-button>
...
import { tableDataList, archivingDel } from '@/api/engineering/security/fireControl'
